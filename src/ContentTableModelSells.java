 ...
 * @author kamen
 */
public class ContentTableModelSells extends AbstractTableModel {
	...
	public ContentTableModelSells() {
        csvRecords = new ArrayList<>();
    }

	public ContentTableModelSells(ArrayList<CSVRecord> csvRecords) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
			...
			case 9: return csvRecord.result;
